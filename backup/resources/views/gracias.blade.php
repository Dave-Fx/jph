        ...
        @push('head')
            @if (session('data') != "web")
                <script>
                    ...
                    // gtag('event', 'whatsapp-btn', { 'event_category': 'Whatsapp', 'event_label': 'whatsapp-cm', 'value': '1'});
                    console.log('Analytics +1 event');
                    window.open("https://api.whatsapp.com/send?phone=573222670742&text=%C2%A1Hola%20Antilia%2096%20Cartagena!%20soy%20{{ session('data') }}%2C%20puedes%20darme%20m%C3%A1s%20informaci%C3%B3n%20sobre%20el%20proyecto%3F", "_self")
                </script>
            @endif
        @endpush
    @endif
