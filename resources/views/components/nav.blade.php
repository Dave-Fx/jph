...
<nav class="bg-primary flex items-center justify-around h-28 bg-texture bg-center">
    {{-- Dropmenu sidebar --}}
    <div class="">
        <button type="button" class="py-4 text-2xl top-0 z-40 text-secondary" data-drawer-target="drawer-navigation"
            data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class=" w-12 md:h-16 md:w-16">
        ...
        <div id="drawer-navigation"
            class="fixed transition duration-700 ease-in-out z-40 h-screen p-4  overflow-y-auto bg-secondary w-80 hidden"
            ...
            <div class="py-4 overflow-y-auto flex justify-center">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a @click="modelOpen =!modelOpen" data-drawer-dismiss="drawer-navigation"
                            aria-controls="drawer-navigation"
                            class="flex items-center p-3 text-2xl font-normal text-white  cursor-pointer bg-primary hover:bg-primary/80 ">
    ...
    {{-- Logo --}}
    <a href="{{ route('index') }}">
        <img class=" py-3 w-32 md:w-48" src="{{ asset('assets/img/logo.webp') }}" alt="Logo">
    </a>
    {{-- Redes Sociales --}}
    <div class=" flex gap-4">
        <a href="https://www.facebook.com/Antilia96Ctg" target="_blank"><img class=" w-7 md:w-10"
                src="{{ asset('assets/img/social/facebook.svg') }}" alt=""></a>
        <a href="https://www.instagram.com/antilia96ctg/" target="_blank"><img class=" w-7 md:w-10"
                src="{{ asset('assets/img/social/instagram.svg') }}" alt=""></a>
    </div>
</nav>
